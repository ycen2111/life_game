...
// 
// Create Date: 16.02.2023 15:44:11
// Design Name: DR ALISTER HAMILTON & Yang Cen
// Module Name: MouseMasterSM
// Project Name: MicroProcessor
// Target Devices: BAYSY 3 XC7A35T-l CPG236C
// Tool Versions: Vivado 2015.2
// Description: control the whole communication step with mouse, like the initialize code ect.
// 
// Dependencies: 
// 
// Revision:
...
module MouseMasterSM(
    ...
    reg [28:0] Curr_Counter, Next_Counter;
    //Transmitter Control
    ...
    always@* begin
        ...
        case(Curr_State)
            ...
            4'h8: begin
                if(BYTE_READY) begin
                    if(BYTE_READ == 8'hF4) //? why no BYTE_ERROR_CODE == 2'b00
                        Next_State = 4'h9;
                    else
                        Next_State = 4'h0;
                end
